...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Speaker, XT Summit 2017}
          {Introduced AMP/PWA solutions and presented as a speaker at Sapient's XT SUMMIT 2017.}
      \resumeItemListEnd
...
\section{Achievments}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{o9}{ -Performer of the Quarter October 2023 \& Performer of the Month- July 2021 } \\
     \textbf{Personal}{ - Featured on BBC, TOI, Boing Boing, Saudi Gazette, Mashable, etc. } \\
